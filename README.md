...
- **[User Guide](docs/USER_GUIDE.md)** — Step-by-step guide with 12 hands-on use cases. Start here if you are new to ZeroClaw.
- **[Quick Start](#quick-start)** — Installation and first conversation (above).
...
- [Hardware Peripherals Design](docs/hardware-peripherals-design.md)
...
- [Mattermost Setup](docs/mattermost-setup.md)
- [Nucleo Board Setup](docs/nucleo-setup.md)
- [Arduino Uno Q Setup](docs/arduino-uno-q-setup.md)
